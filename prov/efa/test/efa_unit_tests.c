...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_group_b_with_peer_support, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_peer_error_recv_malformed_drops, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
