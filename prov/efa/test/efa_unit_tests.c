...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_peer_error_recv_longcts_op_id_hint, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_init_peer_error_for_ope_longcts_pre_cts_skip, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_cts_parked_before_handshake_applied_on_handshake, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_cts_parked_before_handshake_stale_dropped, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
