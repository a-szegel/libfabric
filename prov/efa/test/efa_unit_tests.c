...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_medium_suppresses_peer_error_on_zero_delivery, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_dc_medium_suppresses_peer_error_on_zero_delivery, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
