...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_medium_emits_peer_error_on_invalid_lkey, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_dc_medium_emits_peer_error, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_medium_emits_with_homogeneous_peers, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
