...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_requeues_msg, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_writes_cq_err_when_buffer_touched, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_multi_recv_writes_err_for_failed_msg, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_emits_peer_error_pkt, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_reentry_safe, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_handle_peer_aborted_op_cq_err_with_peer_support, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
