...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_info_dgram_open_with_fi_av_map, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_info_rdm_open_with_fi_av_map, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
