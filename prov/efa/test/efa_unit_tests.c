...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_srx_repost_peer_rxe_msg_unspec, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_srx_repost_peer_rxe_tag_unspec, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_srx_repost_peer_rxe_null_input, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_srx_repost_peer_rxe_msg_directed, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_recover_from_peer_abort_requeues_msg, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_rxe_recover_from_peer_abort_multi_recv_writes_err, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_longread_bad_address_requeues, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_longread_abort_requeues, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_tx_error_longread_tagged_requeues, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_peer_error_recv_longcts_requeues_rxe, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_pke_handle_peer_error_recv_medium_requeues_rxe, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
