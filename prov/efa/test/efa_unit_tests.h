...
void test_efa_rdm_rxe_handle_peer_aborted_op_requeues_msg();
...
void test_efa_rdm_rxe_handle_peer_aborted_op_emits_peer_error_pkt();
void test_efa_rdm_pke_handle_send_completion_peer_error_releases_rxe();
void test_efa_rdm_rxe_handle_peer_aborted_op_reentry_safe();
void test_efa_rdm_rxe_handle_peer_aborted_op_cq_err_with_peer_support();
