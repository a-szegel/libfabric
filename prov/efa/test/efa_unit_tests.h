...
void test_efa_rdm_msg_send_0_byte();
void test_efa_rdm_msg_sendv_0_byte();
void test_efa_rdm_msg_sendmsg_0_byte();
void test_efa_rdm_msg_senddata_0_byte();
void test_efa_rdm_msg_inject_0_byte();
void test_efa_rdm_msg_injectdata_0_byte();
void test_efa_rdm_tagged_send_0_byte();
void test_efa_rdm_tagged_sendv_0_byte();
void test_efa_rdm_tagged_sendmsg_0_byte();
void test_efa_rdm_tagged_senddata_0_byte();
void test_efa_rdm_tagged_inject_0_byte();
void test_efa_rdm_tagged_injectdata_0_byte();
void test_efa_rdm_rma_read_0_byte();
void test_efa_rdm_rma_readv_0_byte();
void test_efa_rdm_rma_readmsg_0_byte();
void test_efa_rdm_rma_write_0_byte();
void test_efa_rdm_rma_writev_0_byte();
void test_efa_rdm_rma_writemsg_0_byte();
void test_efa_rdm_rma_writedata_0_byte();
void test_efa_rdm_rma_inject_write_0_byte();
void test_efa_rdm_rma_inject_writedata_0_byte();
