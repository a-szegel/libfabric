...
void test_av_rdm_reverse_lookup_explicit();
void test_av_rdm_addr_to_entry_after_remove();
void test_av_rdm_insert_remove_with_peer();
void test_av_implicit_to_explicit_peer_updated();
void test_av_rdm_batch_insert();
void test_av_rdm_remove_nonexistent();
void test_av_rdm_prv_reverse_av();
void test_av_rdm_insert_invalid_address();
void test_av_implicit_av_unbounded();
void test_av_rdm_open_unsupported_attrs();
