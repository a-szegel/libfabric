...
{
	struct efa_rdm_av *rdm_av = container_of(av, struct efa_rdm_av, efa_av);
	...
	assert_int_equal(HASH_CNT(hh, rdm_av->util_av_implicit.hash),
			 implicit_cur_av_count + implicit_prv_av_count);
	assert_int_equal(HASH_CNT(hh, rdm_av->cur_reverse_av_implicit),
			 implicit_cur_av_count);
	assert_int_equal(HASH_CNT(hh, rdm_av->prv_reverse_av_implicit),
...
void test_av_reinsertion(struct efa_resource **state)
{
	...
	assert_int_equal(efa_is_same_addr(&raw_addr, efa_rdm_av_entry_ep_addr(peer->av_entry)), 1);
...
static struct efa_rdm_peer *test_av_get_peer_from_implicit_av(struct efa_resource *resource)
{
	...
	err = efa_rdm_av_insert_one(container_of(av, struct efa_rdm_av, efa_av), &raw_addr, &implicit_fi_addr, 0, NULL, true, true);
	assert_int_equal(err, 0);
	...
	test_addr = efa_rdm_av_reverse_lookup_implicit(container_of(av, struct efa_rdm_av, efa_av), ahn, raw_addr.qpn, NULL);
...
void test_av_implicit_to_explicit(struct efa_resource **state)
{
	...
	/* Insert explicitly */
	raw_addr.qpn = efa_rdm_av_entry_ep_addr(peer->av_entry)->qpn;
	raw_addr.qkey = efa_rdm_av_entry_ep_addr(peer->av_entry)->qkey;
	...
	ahn = efa_rdm_ep->self_ah->ahn;
	test_addr = efa_rdm_av_reverse_lookup(container_of(av, struct efa_rdm_av, efa_av), ahn, raw_addr.qpn, NULL);
...
static void test_av_implicit_av_verify_lru_list_first_last_elements(
	struct efa_av *av, struct efa_rdm_av_entry *first_conn_expected,
	struct efa_rdm_av_entry *last_conn_expected)
{
	struct dlist_entry *first_entry, *last_entry;
	struct efa_rdm_av_entry *first_conn_actual, *last_conn_actual;

	first_entry = container_of(av, struct efa_rdm_av, efa_av)->implicit_av_lru_list.next;
	last_entry = container_of(av, struct efa_rdm_av, efa_av)->implicit_av_lru_list.prev;

	first_conn_actual = container_of(first_entry, struct efa_rdm_av_entry,
					 implicit_av_lru_entry);
	last_conn_actual = container_of(last_entry, struct efa_rdm_av_entry,
					implicit_av_lru_entry);
...
void test_av_implicit_av_lru_insertion(struct efa_resource **state)
{
	...
	ahn = efa_rdm_ep->self_ah->ahn;
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	implicit_fi_addr = efa_rdm_av_reverse_lookup_implicit(
		container_of(av, struct efa_rdm_av, efa_av), ahn,
		efa_rdm_av_entry_ep_addr(peer0->av_entry)->qpn, NULL);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
	...
	implicit_fi_addr = efa_rdm_av_reverse_lookup_implicit(
		container_of(av, struct efa_rdm_av, efa_av), ahn,
		efa_rdm_av_entry_ep_addr(peer2->av_entry)->qpn, NULL);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
	...
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	err = efa_rdm_av_insert_one(container_of(av, struct efa_rdm_av, efa_av), efa_rdm_av_entry_ep_addr(peer1->av_entry), &implicit_fi_addr, 0, NULL, true, true);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
	assert_int_equal(err, 0);
	...
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	err = efa_rdm_av_insert_one(container_of(av, struct efa_rdm_av, efa_av), efa_rdm_av_entry_ep_addr(peer2->av_entry), &implicit_fi_addr, 0, NULL, true, true);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
	assert_int_equal(err, 0);
	assert_int_equal(implicit_fi_addr, 2);
	test_av_verify_av_hash_cnt(av, 0, 0, 3, 0);
...
void test_av_implicit_av_lru_eviction(struct efa_resource **state)
{
	...
	container_of(av, struct efa_rdm_av, efa_av)->implicit_av_size = 2;
	 ...
	 */
	memcpy(&peer1_ep_addr, efa_rdm_av_entry_ep_addr(peer1->av_entry),
	...
	memcpy(&peer2_ep_addr, efa_rdm_av_entry_ep_addr(peer2->av_entry),
	       sizeof(struct efa_ep_addr));
	...
	assert_int_equal(HASH_CNT(hh, container_of(av, struct efa_rdm_av, efa_av)->evicted_peers_hashset), 1);
	HASH_FIND(hh, container_of(av, struct efa_rdm_av, efa_av)->evicted_peers_hashset, &peer1_ep_addr,
	...
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	err = efa_rdm_av_insert_one(container_of(av, struct efa_rdm_av, efa_av), efa_rdm_av_entry_ep_addr(peer0->av_entry), &implicit_fi_addr, 0, NULL, true, true);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
	assert_int_equal(err, 0);
	assert_int_equal(implicit_fi_addr, 0);
	test_av_verify_av_hash_cnt(av, 0, 0, 2, 0);
	...
	assert_int_equal(HASH_CNT(hh, container_of(av, struct efa_rdm_av, efa_av)->evicted_peers_hashset), 2);
	HASH_FIND(hh, container_of(av, struct efa_rdm_av, efa_av)->evicted_peers_hashset, &peer2_ep_addr,
		  sizeof(struct efa_ep_addr), efa_ep_addr_hashable);
	assert_non_null(efa_ep_addr_hashable);
...
void test_ah_refcnt(struct efa_resource **state)
{
	...
	/* Manually insert into implicit AV */
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	err = efa_rdm_av_insert_one(container_of(av, struct efa_rdm_av, efa_av), &raw_addr, &fi_addr, 0, NULL, true, true);
	...
	assert_int_equal(efa_rdm_ah_from_ah(efa_ah)->explicit_refcnt, 0);
	assert_int_equal(efa_rdm_ah_from_ah(efa_ah)->implicit_refcnt, 1);
	...
	assert_int_equal(HASH_CNT(hh, efa_domain->ah_map), 1);
	assert_int_equal(efa_rdm_ah_from_ah(efa_ah)->explicit_refcnt, 1);
	assert_int_equal(efa_rdm_ah_from_ah(efa_ah)->implicit_refcnt, 0);
...
void test_ah_lru_eviction_impl(bool explicit)
{
	...
	err = efa_rdm_av_insert_one(container_of(efa_av[0], struct efa_rdm_av, efa_av), &raw_addr[0], &fi_addr, 0, NULL, true, true);
	...
	if (explicit) {
		...
		ofi_genlock_lock(&efa_rdm_ep[0]->base_ep.domain->srx_lock);
		err = efa_rdm_av_insert_one(container_of(efa_av[0], struct efa_rdm_av, efa_av), &raw_addr[1], &fi_addr, 0, NULL, true, true);
		peer = efa_rdm_ep_get_peer_implicit(efa_rdm_ep[0], fi_addr);
		ofi_genlock_unlock(&efa_rdm_ep[0]->base_ep.domain->srx_lock);
	}
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_reverse_lookup_explicit(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_ep_addr raw_addr = {0};
	size_t raw_addr_len = sizeof(struct efa_ep_addr);
	...
	efa_unit_test_resource_construct(resource, FI_EP_RDM, EFA_FABRIC_NAME);
	av = container_of(resource->av, struct efa_av, util_av.av_fid);
	rdm_av = container_of(av, struct efa_rdm_av, efa_av);
	efa_rdm_ep = container_of(resource->ep, struct efa_rdm_ep, base_ep.util_ep.ep_fid);
	ahn = efa_rdm_ep->self_ah->ahn;

	/* Reverse lookup on empty AV should return NOTAVAIL */
	lookup_addr = efa_rdm_av_reverse_lookup(rdm_av, ahn, 42, NULL);
	...
	lookup_addr = efa_rdm_av_reverse_lookup(rdm_av, ahn, 99, NULL);
	assert_int_equal(lookup_addr, FI_ADDR_NOTAVAIL);
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_addr_to_entry_after_remove(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_ep_addr raw_addr = {0};
	size_t raw_addr_len = sizeof(struct efa_ep_addr);
	...
	entry = efa_rdm_av_addr_to_entry(rdm_av, 0);
	assert_null(entry);
	...
	entry = efa_rdm_av_addr_to_entry(rdm_av, fi_addr);
	...
	assert_int_equal(efa_rdm_av_entry_ep_addr(entry)->qpn, 99);
	assert_int_equal(efa_rdm_av_entry_ep_addr(entry)->qkey, 0x9999);
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_insert_remove_with_peer(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_ep_addr raw_addr = {0};
	size_t raw_addr_len = sizeof(struct efa_ep_addr);
	...
	assert_int_equal(peer->av_entry->fi_addr, fi_addr);
	assert_int_equal(peer->av_entry->implicit_fi_addr, FI_ADDR_NOTAVAIL);
	assert_int_equal(efa_rdm_av_entry_ep_addr(peer->av_entry)->qpn, 55);
	assert_int_equal(efa_rdm_av_entry_ep_addr(peer->av_entry)->qkey, 0x5555);
	...
	entry = efa_rdm_av_addr_to_entry(rdm_av, fi_addr);
	assert_non_null(entry);
	assert_ptr_equal(efa_rdm_av_entry_ep_peer_map_lookup(entry, efa_rdm_ep), peer);
...
void test_av_implicit_to_explicit_peer_updated(struct efa_resource **state)
{
	...
	assert_null(efa_rdm_av_addr_to_entry_implicit(rdm_av, implicit_fi_addr));
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_batch_insert(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	...
	for (i = 0; i < 3; i++) {
		entry = efa_rdm_av_addr_to_entry(rdm_av, fi_addrs[i]);
		assert_non_null(entry);
		assert_non_null(entry->ah);
		assert_int_equal(entry->fi_addr, fi_addrs[i]);
		assert_int_equal(efa_rdm_av_entry_ep_addr(entry)->qpn, 10 + i);
		assert_int_equal(efa_rdm_av_entry_ep_addr(entry)->qkey, 0x1000 + i);
	}

	/* Remove one at a time and verify counts */
	fi_av_remove(resource->av, &fi_addrs[0], 1, 0);
	test_av_verify_av_hash_cnt(av, 2, 0, 0, 0);
	assert_null(efa_rdm_av_addr_to_entry(rdm_av, fi_addrs[0]));
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_remove_nonexistent(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_prv_reverse_av(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	...
	struct efa_rdm_av *rdm_av;
	struct efa_rdm_ep *efa_rdm_ep;
	struct efa_rdm_av_entry *entry1, *entry2;
	...
	/* Verify first entry */
	entry1 = efa_rdm_av_addr_to_entry(rdm_av, fi_addr1);
	assert_non_null(entry1);
	assert_int_equal(efa_rdm_av_entry_ep_addr(entry1)->qkey, 0xAAAA);

	/* Reverse lookup should find first entry */
	lookup_addr = efa_rdm_av_reverse_lookup(rdm_av, ahn, 20, NULL);
	...
	/* Verify second entry */
	entry2 = efa_rdm_av_addr_to_entry(rdm_av, fi_addr2);
	assert_non_null(entry2);
	assert_int_equal(efa_rdm_av_entry_ep_addr(entry2)->qkey, 0xBBBB);
...
void test_av_reverse_av_remove_qpn_collision(struct efa_resource **state)
{
	...
	assert_int_equal(efa_rdm_av_reverse_lookup(rdm_av, ahn, 100, NULL),
			 fi_addr1);
 ...
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_insert_invalid_address(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
...
void test_av_implicit_av_unbounded(struct efa_resource **state)
{
	...
	rdm_av->implicit_av_size = 0;

	for (i = 0; i < num_peers; i++)
		test_av_get_peer_from_implicit_av(resource);

	/* All peers should still be in the implicit AV */
	assert_int_equal(HASH_CNT(hh, rdm_av->util_av_implicit.hash), num_peers);
	/* No peer should have been evicted */
	assert_int_equal(HASH_CNT(hh, rdm_av->evicted_peers_hashset), 0);
}

/**
 * @brief efa_rdm_av_open rejects attr->name and attr->flags (both unsupported)
 *
 * Ensures the early-return error paths in efa_rdm_av_open are exercised.
 *
 * @param[in]	state	struct efa_resource that is managed by the framework
 */
void test_av_rdm_open_unsupported_attrs(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct fi_av_attr av_attr = {0};
...
/**
 * @brief efa_rdm_av_implicit_av_lru_entry_move on a single-element list
 *
 * Insert exactly one implicit peer; the LRU list has exactly one node.
 * Call efa_rdm_av_implicit_av_lru_entry_move on it — this exercises the
...
void test_av_implicit_av_lru_move_single(struct efa_resource **state)
{
	...
	ofi_genlock_lock(&efa_rdm_ep->base_ep.domain->srx_lock);
	efa_rdm_av_implicit_av_lru_entry_move(rdm_av, peer->av_entry);
	ofi_genlock_unlock(&efa_rdm_ep->base_ep.domain->srx_lock);
