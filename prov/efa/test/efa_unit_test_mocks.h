...
ssize_t __real_efa_rdm_pke_copy_payload_to_ope(struct efa_rdm_pke *pke, struct efa_proto_ope_base *ope);

ssize_t efa_mock_efa_rdm_pke_copy_payload_to_ope_return_mock(struct efa_rdm_pke *pke, struct efa_proto_ope_base *ope);

int __real_efa_rdm_pke_read(struct efa_proto_ope_base *ope);
...
ssize_t __real_efa_proto_ope_post_send(struct efa_proto_ope_base *ope, int pkt_type);
...
struct efa_unit_test_mocks
{
	...
	ssize_t (*efa_rdm_pke_copy_payload_to_ope)(struct efa_rdm_pke *pke, struct efa_proto_ope_base *ope);

	int (*efa_rdm_pke_read)(struct efa_proto_ope_base *ope);
