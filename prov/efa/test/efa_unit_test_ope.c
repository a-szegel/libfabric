...
/**
 * @brief LONGCTS post-CTS: a PEER_ERROR_PKT carrying the rx_id hint
 *        resolves the receiver's matched rxe directly from the ope pool
 *        (no msg_id lookup); the rxe is marked peer-aborted and, once
