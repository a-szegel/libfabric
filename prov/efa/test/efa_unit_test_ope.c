 ...
 */
void test_efa_rdm_pke_handle_tx_error_longread_bad_address_peer_aborts(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_rdm_ep *ep;
	struct util_srx_ctx *srx_ctx;
 ...
 *        mark + drain writes a clean RX error completion, reaps rxe.
 */
void test_efa_rdm_pke_handle_tx_error_longread_abort_peer_aborts(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_rdm_ep *ep;
	struct util_srx_ctx *srx_ctx;
 ...
 * dependency.
 */
void test_efa_rdm_pke_handle_tx_error_longread_tagged_peer_aborts(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_rdm_ep *ep;
	struct util_srx_ctx *srx_ctx;
 ...
 */
void test_efa_rdm_pke_handle_peer_error_recv_longcts_reaps_rxe(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_rdm_ep *ep;
	struct util_srx_ctx *srx_ctx;
 ...
 */
void test_efa_rdm_pke_handle_peer_error_recv_medium_reaps_rxe(struct efa_resource **state)
{
	struct efa_resource *resource = *state;
	struct efa_rdm_ep *ep;
	struct util_srx_ctx *srx_ctx;
