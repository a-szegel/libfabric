...
/** @brief max number of concurrent send requests allowed by EFA device
 *
 * This value is kept only for test mock infrastructure static array sizing.
 * Production code uses efa_base_ep_get_tx_pool_size() for runtime sizing.
 */
