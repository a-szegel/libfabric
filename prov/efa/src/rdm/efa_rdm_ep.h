...
struct efa_proto_ope_base *efa_proto_ep_alloc_rxe(struct efa_rdm_ep *ep,
...
int efa_rdm_ep_post_user_recv_buf(struct efa_rdm_ep *ep, struct efa_proto_ope_base *rxe,
			      uint64_t flags);
