...
/* A txe id splits the payload: 8 bits of slot generation to tell a live id
 * from one that outlived the slot, 22 bits of pool index, and one bit spare.
 * Leaving the payload short is what keeps a txe id clear of the sentinel. */
