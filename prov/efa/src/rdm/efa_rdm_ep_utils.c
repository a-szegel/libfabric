...
int32_t efa_rdm_ep_get_peer_ahn(struct efa_rdm_ep *ep, fi_addr_t addr)
{
	...
	proto_av = container_of(ep->base_ep.av, struct efa_proto_av, efa_av);
	entry = efa_proto_av_addr_to_entry(proto_av, addr);
...
struct efa_rdm_peer *efa_rdm_ep_get_peer_implicit(struct efa_rdm_ep *ep, fi_addr_t addr)
{
	...
	proto_av = container_of(ep->base_ep.av, struct efa_proto_av, efa_av);
	entry = efa_proto_av_addr_to_entry_implicit(proto_av, addr);
