...
struct efa_rdm_peer {
	...
	struct efa_rdm_av_entry *av_entry;		/**< pointer to efa_rdm_av_entry in the av entry */
...
void efa_rdm_peer_construct(struct efa_rdm_peer *peer, struct efa_rdm_ep *ep, struct efa_rdm_av_entry *av_entry);
