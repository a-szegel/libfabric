...
server_args = f" --pin-core 44 -p efa -w {warmup_iterations} -I {iterations} -S 1024 -E "
...
def get_and_print_statistics(vector, name):
    ...
    print(f"{name} Average: {avg}, pstd: {pstd}, min: {minimum}, max: {maximum}, median: {median}, num_samples: {num_samples}, unique: {unique}, num_outliers: {num_outliers}")
...
get_and_print_statistics(server_rdma_core_to_libfabric, "Timing Test")
...
get_and_print_statistics(client_rdma_core_to_libfabric, "Timing Test")
